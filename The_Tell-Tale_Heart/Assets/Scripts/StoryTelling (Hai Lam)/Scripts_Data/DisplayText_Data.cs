...
{
    /*[SerializeField]
    private float flowTextDelay = 0.01f; //Display Speed

    [SerializeField]
    private float closeTextDelay; //Waiting time to close text*/

    [SerializeField]
    private bool hasTextBeenPlayed = false;

    [SerializeField]
    private GameObject whichStoryTMP; //Which TMP text are we talking about
